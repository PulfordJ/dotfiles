...
in {
  wayland.windowManager.hyprland = {
    ...
    extraConfig = ''
      ...
      bind=SHIFT,S,exec,${lib.getExe scripts.prompt} 'Do you want to suspend-then-hibernate?' 'sleep 0.6 && loginctl lock-session && sleep 1 && systemctl suspend-then-hibernate -i'
